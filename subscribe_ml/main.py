...
def handle_message(row_data):
    try:
        ...
        features = [
            "T2","T2_diff","T2_roll",
            "T24","T24_diff","T24_roll",
            "T30","T30_diff","T30_roll",
            "T50","T50_diff","T50_roll",
            "P2","P2_diff","P2_roll",
            "P15","P15_diff","P15_roll",
            "P30","P30_diff","P30_roll",
            "Nf","Nf_diff","Nf_roll",
            "Nc","Nc_diff","Nc_roll",
            "epr","epr_diff","epr_roll",
            "Ps30","Ps30_diff","Ps30_roll",
            "phi","phi_diff","phi_roll",
            "NRf","NRf_diff","NRf_roll",
            "NRc","NRc_diff","NRc_roll",
            "BPR","BPR_diff","BPR_roll",
            "farB","farB_diff","farB_roll",
            "htBleed","htBleed_diff","htBleed_roll",
            "Nf_dmd","Nf_dmd_diff","Nf_dmd_roll",
            "PCNfR_dmd","PCNfR_dmd_diff","PCNfR_dmd_roll",
            "W31","W31_diff","W31_roll",
            "W32","W32_diff","W32_roll",
            "setting1","setting2","setting3",
            "RUL"
        ]

        features_for_model = pd.DataFrame([current_row])[features].dropna()
